...
public class WebSteps {
    ...
    public void i_press_down_arrow_key() {
        Actions actions = new Actions(driver);
        actions.sendKeys(Keys.ARROW_DOWN).perform();
    }

    public int getRandomNumberBetween1And20() {
        return new Random().nextInt(20) + 1;
    }

    @And("I use random number to the weight {string}")
    public void i_use_random_number_to_the_weight(String locator) {
        int randomNumber = getRandomNumberBetween1And20();
        By element = constructElement(findElementRepo(locator));
        driver.findElement(element).sendKeys(String.valueOf(randomNumber));
    }
