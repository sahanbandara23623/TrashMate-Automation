Feature: Request Waste Collection Feature
  ...
  Background:
    ...
    And I type "Vinnath@1234" to the "Password"
  ...
  Scenario: Enter large amount Weights for Food Waste
    And I wait few seconds
    And I click on "Weight_Food"
    And I type "9999" to the "Weight_Food"
    And I wait few seconds
    And I click on "Proceed_Payment_Button"
    And I wait few seconds

  Scenario: Enter large amount Weights for Polythene Waste
    And I wait few seconds
    And I click on "Weight_Polythene"
    And I type "9999" to the "Weight_Polythene"
    And I wait few seconds
    And I click on "Proceed_Payment_Button"
    And I wait few seconds